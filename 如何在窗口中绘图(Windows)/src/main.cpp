...
void initSurface() {
    ...
    sk_sp<SkSurface> surface = SkSurfaces::WrapPixels(info, surfaceMemory.get(), 4 * w);
...
void initWindow() {
    ...
    auto hwnd = CreateWindow(clsName.c_str(), clsName.c_str(), WS_OVERLAPPEDWINDOW, 100, 100, w, h, nullptr, nullptr, hinstance, nullptr);
